...
public:
	...
	FGameplayTag InputTag_Hold;
	FGameplayTag InputTag_Hold_Block;
	FGameplayTag InputTag_Hold_Interaction_1;
	FGameplayTag InputTag_Hold_Interaction_2;
	FGameplayTag InputTag_Hold_Interaction_3;
	FGameplayTag InputTag_Hold_MainAction;
	FGameplayTag InputTag_Hold_SubAction;
	...
	FGameplayTag Event_Montage_AttackStart;
	...
	FGameplayTag Shared_Ability_Block;
	FGameplayTag Shared_Ability_Parry;
	...
	FGameplayTag Player_State_Lock;
	FGameplayTag Player_State_Evade;
	
	FGameplayTag Shared_State_Block;	
	...
	FGameplayTag GameplayCue_Sound_Hit_Shield;
