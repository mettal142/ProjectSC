...
public:
	...
	UFUNCTION(BlueprintCallable, Server, Reliable)
	void UnequipAndDestroyWeapon(const FGameplayTag& EquippedSocket);
	
	UFUNCTION()
	void UpdateEquippedArmors();

	UFUNCTION(BlueprintCallable)
	void MeleeAttackTraceWithRange(const FVector& Attacklocation, float Radius);
