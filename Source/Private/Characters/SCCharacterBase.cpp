...
void ASCCharacterBase::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME(ASCCharacterBase, LightAttackMontages);
	DOREPLIFETIME(ASCCharacterBase, HeavyAttackMontages);
...
TArray<TSoftObjectPtr<UAnimMontage>> ASCCharacterBase::GetLightAttackMontages_Implementation()
{
	return LightAttackMontages;
}


TArray<TSoftObjectPtr<UAnimMontage>> ASCCharacterBase::GetHeavyAttackMontages_Implementation()
{
...
UAnimMontage* ASCCharacterBase::GetParriedMontage_Implementation()
{
	return ParriedMontage;
}
...
void ASCCharacterBase::BeginPlay()
{
	...
	{
		LightAttackMontages = StartUpData->LightAttackMontages;
		HeavyAttackMontages = StartUpData->HeavyAttackMontages;
	}
}
