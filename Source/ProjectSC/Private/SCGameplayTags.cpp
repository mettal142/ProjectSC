...
void FSCGameplayTags::InitializeNativeGameplayTags()
{
	 ...
	 * Input Tag
	 */
	GameplayTags.InputTag_Move = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("InputTag.Move"), FString("Input Tag for Left Mouse Button"));
	GameplayTags.InputTag_Look = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("InputTag.Look"), FString("Input Tag for Left Mouse Button"));
	...
	GameplayTags.InputTag_Block = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("InputTag.Block"), FString("Input Tag for Block"));
	...
	* Event
	*/
	GameplayTags.Event_Montage_AttackEnd = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Event.Montage.AttackStart"), FString("Attack Start Tag"));
	...
	*/
	...
	GameplayTags.Player_Ability_Block = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Player.Ability.Block"), FString("Ability Tag for Right Mouse Button"));
