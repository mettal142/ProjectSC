...
void ASCHUD::SetWidgetControllerParams()
{
...
UQuickSlotWidgetController* ASCHUD::GetQuickSlotWidgetController(const FWidgetControllerParams& WCParams)
{
	if (!QuickSlotWidgetController)
	{
		...
		QuickSlotWidgetController->SetWidgetControllerParams(WCParams);
